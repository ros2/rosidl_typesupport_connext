...
from rosidl_typesupport_connext_c import generate_typesupport_connext_c


class GenerateConnextCTypesupport(GenerateCommandExtension):
    ...
    def generate(
        ...
        package_share_path = pathlib.Path(
            get_package_share_directory('rosidl_typesupport_connext_c'))
        ...
        visibility_control_file_template_path = \
            'rosidl_typesupport_connext_c__visibility_control.h.in'
        visibility_control_file_template_path = \
            templates_path / visibility_control_file_template_path

        visibility_control_file_path = \
            'rosidl_typesupport_connext_c__visibility_control.h'
        visibility_control_file_path = \
        ...
        with legacy_generator_arguments_file(
            ...
            generated_files.extend(
                generate_typesupport_connext_c(path_to_arguments_file)
            )
